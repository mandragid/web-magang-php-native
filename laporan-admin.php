        ...
        <div class="container-sidebar pl-4 text-center">
          <div class="button-sidebar-section">
            <div class="row">
              ...
              <div class="col-10 mt-3">
                <a id="button-sidebar" href="./dashboard-admin.php" id="button-sidebar">
                  Home</a>
              </div>
            </div>
          </div>
          <div class="button-sidebar-section">
            <div class="row">
              <div class="col-2 m-auto"></div>
              <div class="col-10 mt-3">
                <a id="button-sidebar" href="./list-pendaftar.php" id="button-sidebar">
                  Pendaftar</a>
              </div>
            </div>
          </div>
          ...
          <div class="button-sidebar-section">
            <div class="row">
              <div class="col-2 m-auto"></div>
              <div class="col-10 mt-3">
                <a id="button-sidebar-active" href="./laporan-admin.php" id="button-sidebar">
                  Laporan</a>
              </div>
            </div>
          </div>
          <div class="button-sidebar-section">
            <div class="row">
              <div class="col-2 m-auto"></div>
              <div class="col-10 mt-3">
                <a id="button-sidebar" href="./about-admin.php" id="button-sidebar">
                  About</a>
              </div>
            </div>
          </div>
